  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 z-50 w-12 h-12 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors duration-200 hover:scale-105 shadow-lg"
          style={{ zIndex: 9999 }}
        >
